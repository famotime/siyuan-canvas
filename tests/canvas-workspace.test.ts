...
describe("CanvasWorkspace", () => {
  ...
  it("renders a floating edge toolbar with an icon-triggered direction dropdown", async () => {
    ...
    expect(wrapper.find("[data-testid='edge-toolbar-edit-label']").attributes("aria-label")).toBe("编辑文字")
    expect(wrapper.find("[data-testid='edge-toolbar-edit-label']").attributes("data-tooltip")).toBe("编辑文字")
