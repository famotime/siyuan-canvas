...
import {
  findSiyuanAssetByPath as findCanvasSiyuanAssetByPath,
  findSiyuanDocumentByPath as findCanvasSiyuanDocumentByPath,
  type SiyuanResolvedAsset,
  type SiyuanResolvedDocument,
} from "@/canvas/siyuan-kernel-file-node-lookups";
export type {
  SiyuanResolvedAsset as ISiyuanResolvedAsset,
  SiyuanResolvedDocument as ISiyuanResolvedDocument,
} from "@/canvas/siyuan-kernel-file-node-lookups";
